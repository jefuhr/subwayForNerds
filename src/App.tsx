...
export default function App() {
  ...
  const [panel, setPanel] = useState<'stations' | 'themes' | 'alerts' | 'context' | 'filters' | 'direction' | null>(null);
    ...
    <main className="main-panel">
      ...
      <div className="board-content">
        ...
        <section id="departures" className="departure-board" tabIndex={-1}>
          ...
          <div className="direction-control"><button className="text-button" aria-label="Choose direction" onClick={() => setPanel('direction')}><ArrowUp size={14} /><ArrowDown size={14} />{direction === 'ALL' ? 'All directions' : direction === 'NORTH' ? 'Northbound' : 'Southbound'}<ChevronDown size={13} /></button></div>
